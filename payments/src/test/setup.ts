...
process.env.STRIPE_KEY =
  'sk_test_51JeLYGCLTIVy6PpabbhM3fk9MFdAz1YjNdtLgBdemBJDbZRTI9XTfYVJm6u18xQVdFni1i0AuxmExGnCRVTXy1l100Py3hrVsz';
...
global.signin = (id?: string) => {
  ...
  const payload = {
    id: id || new mongoose.Types.ObjectId().toHexString(), //to randomly generate an id when signin() is called
    email: 'test@test.com',
  };
